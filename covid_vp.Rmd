...
tab = topTable(fit, coef="choroidpleus", number=Inf)
...
index = ids2indices( geneSets_GO, rownames(tab))
...
res_zenith = zenith( fit, "choroidpleus", index)

res_zenith[1:20,] %>% kable %>% kable_styling(full_width = FALSE) 
