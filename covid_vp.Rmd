...
# a = getGenesets("./genesets.gmt", return.type = "GeneSetCollection")
...
I included GO, KEGG, and 205 COVID-related gene sets from [Avi Ma'ayn's group](https://maayanlab.cloud/covid19/#nav-genes-table).  This figure shows all genes sets with p< 4e-4 in any tissue or cell type.
