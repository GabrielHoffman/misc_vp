...
vpList = lapply( CTs, function(CT){
  ...
  fitExtractVarPartModel( geneExpr_mean[,idx], form, metadata_mean[idx,], BPPARAM=SnowParam(5, progressbar=TRUE))   
  })
names(vpList) = CTs
```

```{r plot.vp.CT.summary, fig.width=12, fig.height=20}
figList = lapply( names(vpList), function(ID){
  vp = vpList[[ID]]
