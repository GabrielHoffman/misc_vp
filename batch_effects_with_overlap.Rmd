...
# total number of experiments: N*n_time_points
opt$p = 1500
opt$n_de = 500 # genes different between case and control
opt$n_tp = 500 # genes different between time points
opt$corrRetain = .8
...
resultsAll = lapply( c(.2), function(alpha){
	...
	set.seed(1)
	# opt$n_total = 1200
	opt$n_controls_per_batch = 20
	opt$n_samples_per_batch = 300
