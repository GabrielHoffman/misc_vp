...
ggplot(df_coexprNorm, aes(method, (coexprNorm^2 - p)/(p*(p-1)) , fill=method)) + geom_bar(stat="identity") + theme_bw(15) + theme(aspect.ratio=1, legend.position="none") + coord_flip() + ylab("Mean squared error") + ggtitle("Coexpression error") #+ facet_wrap()
