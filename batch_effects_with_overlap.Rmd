...
opt$n_total = 3000 # total number of experiments
# opt$n_samples_per_batch = 10 # size of each batch
# opt$n_controls_per_batch = 2 # modify this parameter
opt$n_time_points = 2
# total number of experiments: N*n_time_points
opt$p = 5000
opt$n_de = 2000 # genes different between case and control
...
resultsAll = lapply( c(1,2,3,4,5, 6, 8, 10, 12, 15), function(n_controls_per_batch){
	opt$n_controls_per_batch = n_controls_per_batch

	res = lapply( c(.2), function(alpha){
		opt$alpha = alpha

		message( opt$n_controls_per_batch, " ", opt$alpha)

		res = lapply( 100, function(n_samples_per_batch){
