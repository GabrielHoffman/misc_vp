...
resultsAll = lapply( c( 2, 4, 8, 12, 20, 30, 40, 50), function(n_control){
	...
	res = lapply( n_control, function(n_controls_per_batch){
		...
		res = lapply( c(0.1), function(alpha){
			...
			res = lapply( c(4, 8, 15, 30, 40, 45), function(n_samples_per_batch){

				opt$n_samples_per_batch = n_samples_per_batch

				if( opt$n_controls_per_batch >= opt$n_samples_per_batch){
					return(NULL)
				}
