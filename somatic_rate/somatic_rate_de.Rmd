...
res.zen1 = zenith_gsa(fitList[["SomaticRate"]], "SomaticRate") %>%
  as_tibble %>%
  mutate(test = "SomaticRate")

res.zen2 = zenith_gsa(fitList[["SomaticRate:Dx"]], "SomaticRate:c11x.L") %>%
  as_tibble %>%
  mutate(test = "SomaticRate:Dx")

res.zen3 = zenith_gsa(fitList[["SomaticRate:Age"]], "scale(Age):SomaticRate") %>%
  as_tibble %>%
  mutate(test = "SomaticRate:Age")
```
